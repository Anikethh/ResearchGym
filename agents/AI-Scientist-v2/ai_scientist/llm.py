...
def create_client(model) -> tuple[Any, str]:
    # Uniform handling for OpenAI, Azure OpenAI, and OpenAI-compatible proxies (e.g., LiteLLM)
    # If OPENAI_BASE_URL is set, use it for OpenAI client to support LiteLLM or vendor proxies.
    if model.startswith("claude-"):
        ...
        # Support both AZURE_OPENAI_* and AZUREAI_OPENAI_* naming conventions
        azure_api_key = os.environ.get("AZURE_OPENAI_API_KEY") or os.environ.get("AZUREAI_OPENAI_API_KEY")
        azure_endpoint = os.environ.get("AZURE_OPENAI_ENDPOINT") or os.environ.get("AZUREAI_OPENAI_BASE_URL")
        
        if azure_api_key and azure_endpoint:
            # Azure OpenAI via OpenAI client vars
        ...
        print(f"Using OpenAI-compatible Gemini API with {model}.")
