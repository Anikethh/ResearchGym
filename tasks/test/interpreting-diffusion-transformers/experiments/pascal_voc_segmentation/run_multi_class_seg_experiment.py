...
from concept_attention.flux_multi_class_segmentation import FluxMultiClassSegmentation
...
if __name__ == "__main__":
    ...
    if args.segmentation_model == "RawCrossAttention" or args.segmentation_model == "RawOutputSpace" or args.segmentation_model == "RawValueSpace":
        ...
        segmentation_model = FluxMultiClassSegmentation(generator=generator)
