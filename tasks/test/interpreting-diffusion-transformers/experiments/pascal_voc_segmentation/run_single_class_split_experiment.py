"""
Evaluate baseline models on Pascal VOC images containing a single class, using only neutral
segmentation/explainability methods (e.g., CLIP-based and diffusion-based baselines).
"""
