"""
DINO-based segmentation baseline.
"""
import torch
...
from baseline_segmentation.segmentation_base import SegmentationAbstractClass
import baseline_segmentation.dino_src.vision_transformer as vits

class DINOSegmentationModel(SegmentationAbstractClass):
    """
    DINO-based segmentation model for zero-shot interpretability evaluation.
    """
    ...
    def __init__(self, arch="vit_small", patch_size=8, image_size=480, image_path=None, device="cuda"):
        ...
        if url is not None:
            ...
            print("No reference weights available for this model => Using random weights.")
    ...
    def segment_individual_image(self, image, concepts, caption, **kwargs):
        """
        Segment image using DINO self-attention.
        Note: DINO is not text-conditioned, so concepts and caption are ignored.
        """
